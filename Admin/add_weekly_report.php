...
if(isset($_POST['Submit'])) {
    ...
    if(empty($S_day)) {
        ...
        echo "  
            ...
            <strong>Count</strong> added successfully !
            </div>
            ";
                                   ...
                                   <center> <div class="ln_solid"></div>
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <a href="view_weekly_report.php"><div class="btn btn-round btn-warning">Cancel </div></a>
                                                <button type="submit" name="Submit" class="btn btn-round btn-success"> Save count </button>
                                            </div>
                                        </div>
